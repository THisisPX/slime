...
# ==================== 路径配置 (请根据实际环境修改) ====================
HF_CHECKPOINT="${HF_CHECKPOINT:-/workspace/models/Qwen3-VL-4B-Instruct}"
SAVE_DIR="${SAVE_DIR:-/workspace/models/Qwen3-VL-4B_slime_geo3k}"
PROMPT_DATA_DIR="${PROMPT_DATA_DIR:-/workspace/datasets}"
